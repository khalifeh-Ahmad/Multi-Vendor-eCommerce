...
class ProductResource extends Resource
{
  ...
  public static function form(Form $form): Form
  {
    return $form
      ->schema([
        Grid::make()
          ->schema([
            ...
            Select::make('department_id')->relationship('department', 'name')
              ->label(__('Department'))->preload()->searchable()->required()->reactive()
        ...
        Select::make('status')->options(ProductStatusEnum::lables())
  ...
  public static function table(Table $table): Table
  {
    return $table
      ->columns([
        SpatieMediaLibraryImageColumn::make('imgaes')->collection('images')->limit(1)
          ->conversion('thumb')->label('Image'),
